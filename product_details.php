    ...
    <!-- Mirrored from 115.160.244.10:8084/themeforest/event_planning/booking_step2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Apr 2018 06:24:02 GMT -->
    <head>
        <!-- Meta information -->
        <meta charset="utf-8">
                    ...
                    <div class="container">
                        ...
                        <div class="right-link">
                            <ul>
                                ...
                                <li class="sub-links">
                                    <a href="javascript:;">John Dove <span class="icon icon-arrow-down"></span></a>
                                    <ul class="sub-nav">
                        ...
                        <div class="navbar navbar-inverse">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="services.php">Services <span class="icon icon-arrow-down"></span></a>
                                        <ul>
                                ...
                                <div class="col-sm-8">
                                    <div class="payment-type saveCard-info">
                                        <div class="saveCard">
                                            ...
                                            <div class="submit-slide">	
                                                <a href="order.php"><input type="submit" value="Pay Now" class="btn"></a>
                                    ...
                                    <div class="payment-type debitCard-info">
                                        <div class="debitCard">
                                            ...
                                            <div class="save-detail">
                                                <label class="label_radio" for="radio-02"><input type="radio" name="sample-radio2" id="radio-02" value="1">Save this card for faster checkout</label>
                                            </div>
                                            <div class="submit-slide">	
                                               <a href="order.php"> <input type="submit" value="Pay Now" class="btn"></a>
                                                <a href="#" class="cancle">Cancel</a>
                                    ...
                                    <div class="payment-type creditCard-info">
                                        <div class="debitCard">
                                            ...
                                            <div class="save-detail">
                                                <label class="label_radio" for="radio-03"><input type="radio" name="sample-radio3" id="radio-03" value="1">Save this card for faster checkout</label>
                                            </div>
                                            <div class="submit-slide">	
                                                <a href="order.php"><input type="submit" value="Pay Now" class="btn"></a>
                                                <a href="#" class="cancle">Cancel</a>
    ...
    <!-- Mirrored from 115.160.244.10:8084/themeforest/event_planning/booking_step2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Apr 2018 06:24:04 GMT -->
    </html>